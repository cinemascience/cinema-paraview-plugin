#include <CinemaImageCompositing.h>
...
vtkStandardNewMacro(CinemaImageCompositing);
...
CinemaImageCompositing::CinemaImageCompositing() {
...
void CinemaImageCompositing::SetController(vtkMultiProcessController* c){
  this->Controller = c;
}

CinemaImageCompositing::~CinemaImageCompositing() = default;

int CinemaImageCompositing::FillInputPortInformation(int port, vtkInformation *info) {
  if(port == 0)
...
int CinemaImageCompositing::FillOutputPortInformation(int port, vtkInformation *info) {
  if(port == 0)
...
int CinemaImageCompositing::RequestData(vtkInformation *request,
