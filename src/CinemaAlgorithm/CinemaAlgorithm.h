...
// VTK Module
#include <CinemaAlgorithmModule.h>
...
class CINEMAALGORITHM_EXPORT CinemaAlgorithm : public vtkAlgorithm {

public:
  static CinemaAlgorithm *New();
  vtkTypeMacro(CinemaAlgorithm, vtkAlgorithm);
