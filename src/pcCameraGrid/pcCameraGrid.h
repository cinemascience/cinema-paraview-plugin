...
#include <pcCameraGridModule.h>

class vtkMultiProcessController;

class PCCAMERAGRID_EXPORT pcCameraGrid : public pcAlgorithm
{

public:
  static pcCameraGrid* New();
  vtkTypeMacro(pcCameraGrid, pcAlgorithm);
...
private:
  pcCameraGrid(const pcCameraGrid&) = delete;
  void operator=(const pcCameraGrid&) = delete;
