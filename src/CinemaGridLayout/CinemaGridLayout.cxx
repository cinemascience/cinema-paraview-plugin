...
vtkStandardNewMacro(CinemaGridLayout);

CinemaGridLayout::CinemaGridLayout() {
  this->SetNumberOfInputPorts(1);
  this->SetNumberOfOutputPorts(1);
}

CinemaGridLayout::~CinemaGridLayout() = default;

int CinemaGridLayout::FillInputPortInformation(int port, vtkInformation *info) {
  if(port == 0)
...
int CinemaGridLayout::FillOutputPortInformation(int port, vtkInformation *info) {
  if(port == 0)
...
int CinemaGridLayout::CopyObject(vtkDataObject *output, vtkDataObject *input) {
...
int CinemaGridLayout::TranslateObject(vtkDataObject *input,
...
int CinemaGridLayout::RequestData(vtkInformation *request,
