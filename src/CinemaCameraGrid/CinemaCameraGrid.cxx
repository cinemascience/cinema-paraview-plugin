...
vtkStandardNewMacro(CinemaCameraGrid);
...
//----------------------------------------------------------------------------
CinemaCameraGrid::CinemaCameraGrid(){
...
void CinemaCameraGrid::SetController(vtkMultiProcessController* c){
  this->Controller = c;
}

int CinemaCameraGrid::FillInputPortInformation(int port, vtkInformation *info) {
  if(port == 0) {
...
int CinemaCameraGrid::FillOutputPortInformation(int port, vtkInformation *info) {
  if(port == 0) {
...
int CinemaCameraGrid::RequestData(vtkInformation *request,
